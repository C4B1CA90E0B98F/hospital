...
<body class="main-body light-theme app sidebar-mini active leftmenu-color">
            ...
            <ul class="side-menu">
                <li class="slide">
                    <a class="side-menu__item" href="/">
                        ...
                        <span class="side-menu__label">Data Pegawai</span>
                    </a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="/data_dokter">
                        <div class="side-angle1"></div>
                        <div class="side-angle2"></div>
                        <div class="side-arrow"></div>
                        <i class="fas fa-user-md" style="font-size:22px; margin-right:10px"></i>
                        <span class="side-menu__label">Data Dokter</span>
                    </a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" href="/jadwal_praktek">
                        <div class="side-angle1"></div>
                        <div class="side-angle2"></div>
                        <div class="side-arrow"></div>
                        <i class="far fa-calendar-alt" style="font-size:20px; margin-right:12px"></i>
                        <span class="side-menu__label">Jadwal Praktek Dokter</span>
                    </a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" href="/data_pasien">
                        <div class="side-angle1"></div>
                        <div class="side-angle2"></div>
                        <div class="side-arrow"></div>
                        <i class="far fa-calendar-alt" style="font-size:20px; margin-right:12px"></i>
                        <span class="side-menu__label">Data Pasien</span>
                    </a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="/tempat_tidur">
                        <div class="side-angle1"></div>
                        <div class="side-angle2"></div>
                        <div class="side-arrow"></div>
                        <i class="fas fa-bed" style="font-size:17px; margin-right:9px"></i>
                        <span class="side-menu__label">Data Tempat Tidur</span>
                    </a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="/data_rawat">
                        <div class="side-angle1"></div>
                        <div class="side-angle2"></div>
                        <div class="side-arrow"></div>
                        <i class="fas fa-procedures" style="font-size:17px; margin-right:9px"></i>
                        <span class="side-menu__label">Data Rawat</span></i>
                    </a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="/obat_perlengkapan">
                        <div class="side-angle1"></div>
                        <div class="side-angle2"></div>
                        <div class="side-arrow"></div>
                        <i class="fas fa-tablets" style="font-size:17px; margin-right:9px"></i>
                        <span class="side-menu__label">Data Obat & Perlengkapan</span>
                    </a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="/data_tindakan">
                        <div class="side-angle1"></div>
                        <div class="side-angle2"></div>
                        <div class="side-arrow"></div>
                        <i class="fas fa-file-medical-alt" style="font-size:22px; margin-right:10px"></i>
                        <span class="side-menu__label">Data Tindakan</span>
                    </a>
            </ul>
            <div class="app-sidefooter">
                <a class="side-menu__item" href="/logout"><svg class="side-menu__icon"
                    ...
                    <div class="tab-pane active" id="side1">
                        <div class="card-body text-center">
                            <div class="dropdown user-pro-body">
                                <div class="">
                                    <img class="avatar avatar-xl brround mx-auto text-center"
                                        src="/gambar/profil.png"><span
    ...
    <div class="main-footer ht-40">
        <div class="container-fluid pd-t-0-f ht-100p">
            <span>Copyright © <script>
                ...
                </script> <a href="https://izo.my.id">Rumah Mu</a></span>
        </div>
    </div>
    <!-- Footer closed -->
    <!-- Back-to-top -->
    ...
    <!-- P-scroll js -->
    <script src="https://laravel.spruko.com/dashfox/ltr/assets/plugins/perfect-scrollbar/perfect-scrollbar.min.js">
    </script>
